      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link to="/settings" className="flex items-center gap-2 text-gray-300 hover:text-white transition-colors group">
                <div className="bg-slate-800 p-1.5 rounded-full border border-slate-700 group-hover:border-purple-500 transition-colors">
